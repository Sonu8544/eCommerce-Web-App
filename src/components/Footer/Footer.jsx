            ...
            <footer class="bg-white dark:bg-gray-900">
                <div class="container px-6 py-12 mx-auto">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                        <div class="sm:col-span-2">
                            ...
                            <div class="flex -mx-2 items-center mt-5">
                                <a href="#" class=" item mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 " aria-label="Reddit">
                                ...
                                <a href="#" class=" item mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 " aria-label="Facebook">
                                    <svg class="w-10 h-10 fill-current " viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a href="#" class=" item mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 " aria-label="Github">
                                    <svg class="w-10 h-10 fill-current" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div class="flex justify-center items-center">
                        <a href="#">
                            <p className='text-white' > &#169;sksonu8544@gmail.com 2024</p>
                        </a>
                    </div>
                </div>
            </footer>
